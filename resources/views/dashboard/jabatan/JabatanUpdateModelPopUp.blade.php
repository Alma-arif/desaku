...
@foreach ($data as $jabatan)
    <div class="modal fade" id="updateUserModal{{ $jabatan->id }}" tabindex="-1"
        aria-labelledby="updateUserModalLabel{{ $jabatan->id }}" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateUserModalLabel{{ $jabatan->id }}">Update Data Jabatan</h5>
